...
# Include invoice validation router
from .api import invoices

# Include invoice router with verify_access dependency for Demo Mode
# (verify_access now just passes, allowing all requests)
app.include_router(
    invoices.router, 
